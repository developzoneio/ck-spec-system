...
Get-ChildItem C:\temp\sd-test\commands\sd\          # expect 12 .md files
...
|---|---|---|
| `commands/` | `~/.claude/commands/sd/` | 12 slash commands (`/sd:feature`, `/sd:bug`, `/sd:rca`, `/sd:refactor`, `/sd:perf`, `/sd:spec`, `/sd:explore`, `/sd:review`, `/sd:setup`, `/sd:release`, `/sd:adr`, `/sd:verify`) |
...
| `skills/` | `~/.claude/skills/sd/` | 7 rule packs, one folder per skill with `SKILL.md` |
